...
window.onload = function() {
    ...
    var hand_height = document.getElementById("hand").getBoundingClientRect().top;
    var topbar_height = document.getElementsByClassName("topbar")[0].clientHeight;
    

    setTimeout(() => {
        window.scrollTo({
            top: (window.pageYOffset + hand_height - topbar_height),
            behavior: "smooth",
            });
    }, 500);
